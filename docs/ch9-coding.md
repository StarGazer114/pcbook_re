...
<QuizSequential :questions="[
  { 
    question: '1. “编程”的本质到底是什么？', 
    options: ['一种神秘的魔法', '把人类的意图拆解成逻辑步骤并翻译给机器看', '单纯地练习打字速度', '修理坏掉的电脑'],
    answer: '把人类的意图拆解成逻辑步骤并翻译给机器看',
    hint: '计算机很死板，需要程序员把步骤拆解得极其细致严谨。'
  },
  { 
    question: '2. 对于完全没有基础的普通人，最推荐入门的编程语言是：', 
    options: ['C 语言', '汇编语言', 'Python (派森)', 'Java'],
    answer: 'Python (派森)',
    hint: 'Python 的语法最接近人类语言，简单好懂，用途极广。'
  },
  { 
    question: '3. “编译”这个过程的作用是什么？', 
    options: ['给程序起个好听的名字', '检查电脑有没有病毒', '把英文代码翻译成机器认识的 0 和 1', '让程序员休息一会儿'],
    answer: '把英文代码翻译成机器认识的 0 和 1',
    hint: '机器只认电子信号（0 和 1），所以需要翻译官（编译器）。'
  }
]" />